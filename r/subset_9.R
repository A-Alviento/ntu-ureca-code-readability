...
for (col in colnames(ownFeaturesDF_isReadable[,c(2, 6, 7, 9, 13, 16, 19, 21, 22)])) {
...
ownFeaturesDF_isReadable = select(ownFeaturesDF_isReadable, c(2, 6, 7, 9, 13, 16, 19, 21, 22, 27))
