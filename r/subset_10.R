...
for (col in colnames(ownFeaturesDF_isReadable[,c(3, 5, 6, 7, 9, 16, 17, 19, 21, 22)])) {
...
ownFeaturesDF_isReadable = select(ownFeaturesDF_isReadable, c(3, 5, 6, 7, 9, 16, 17, 19, 21, 22, 27))
